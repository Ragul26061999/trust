...
import { getNotes, addNote, Note } from '../../lib/notes-db';
          ...
          <Paper sx={{ 
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <Box sx={{ display: 'flex', gap: 0.5 }}>
                <Tooltip title="Add Media"><IconButton size="small" sx={{ color: 'primary.main', bgcolor: alpha(theme.palette.primary.main, 0.05) }}><ImageIcon size={18} /></IconButton></Tooltip>
                <Tooltip title="Add Time"><IconButton size="small" sx={{ color: 'secondary.main', bgcolor: alpha(theme.palette.secondary.main, 0.05) }}><ClockIcon size={18} /></IconButton></Tooltip>
                <Tooltip title="Link Document"><IconButton size="small" sx={{ color: 'info.main', bgcolor: alpha(theme.palette.info.main, 0.05) }}><BriefcaseIcon size={18} /></IconButton></Tooltip>
              </Box>
              <Button 
                variant="contained" 
            ...
            <Card key={post.id} sx={{ 
              ...
              <CardContent sx={{ pb: 2, px: 3, pt: 3 }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 3 }}>
                  ...
                  <IconButton size="small"><MoreIcon size={22} /></IconButton>
                </Box>
        ...
        <Grid size={{ xs: 12, md: 3 }}>
          ...
          <Card sx={{ 
            ...
            <CardContent>
              ...
              <List disablePadding>
                {[
                  { name: 'Sarah Miller', role: 'Project Manager', online: true, color: '#FF7043' },
                  { name: 'Alex Rivera', role: 'Architect', online: true, color: '#42A5F5' },
                  { name: 'Jordan Lee', role: 'UX Lead', online: false, color: '#66BB6A' },
                ].map((person, idx) => (
                  <ListItem key={idx} sx={{ px: 0, py: 1.5 }}>
                    <ListItemAvatar sx={{ minWidth: 50 }}>
                      <Badge
                        ...
                        variant="dot"
                        color={person.online ? "success" : "default"}
                        sx={{ '& .MuiBadge-badge': { width: 10, height: 10, borderRadius: '50%', border: '2px solid white' } }}
                      >
                        <Avatar sx={{ width: 40, height: 40, bgcolor: person.color, fontWeight: 800 }}>{person.name[0]}</Avatar>
                      </Badge>
                    </ListItemAvatar>
                    <ListItemText 
                      primary={person.name}
                      ...
                      secondaryTypographyProps={{ variant: 'caption', fontWeight: 500 }}
                    />
                    <IconButton size="small" sx={{ color: 'primary.main', bgcolor: alpha(theme.palette.primary.main, 0.05) }}>
                      <PlusIcon size={16} />
                    </IconButton>
                  </ListItem>
                ))}
